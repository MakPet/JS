...
/*  Логические операторы || (ИЛИ), && (И), ! (НЕ)
    ...
    Двойное ! для преобразования к логическому типу. Первое конвертирует и вернет противоположное, второе
    коневертирует и снова вернет противоположное.
    ...
    выполнит 1, получит undefined и пойдет дальше. А вот 2 уже будет true, его выведет во второй раз
    ...
    alert( null || 2 && 3 || 4 ); // null это false, 2 && 3 вернет нам 3, т.к если превый операнд истинный,
    то возращается второй. Иными словаме, будет так
...
/*  Циклы while и for
    ...
    Код выполняется пока условие истино. Т.е цикл сначала выведет 0, увеличит i, сравнит, выедет, увеличит
    и так дальше. Интерация - выполнение цикла
